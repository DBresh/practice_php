    ...
    <form action="form.php" enctype="multipart/form-data" method="POST">
        <table>
            <tr>
                ...
                <td><input type="text" name="login" value="<?= isset($form_data['login']) ? $form_data['login'] : "" ?>"></td>
            </tr>
            <tr>
                <td><label for="password">Пароль:</label></td>
                <td><input type="password" name="password" value="<?= isset($form_data['password']) ? $form_data['password'] : "" ?>"></td>
            </tr>
            <tr>
                <td><label for=" repassword">Пароль(ще раз):</label></td>
                <td><input type="password" name="repassword" value="<?= isset($form_data['repassword']) ? $form_data['repassword'] : "" ?>"></td>
            </tr>
            <tr>
                <td><label for="gender">Стать:</label></td>
                <td>
                    <input type="radio" name="gender" value="Чоловік" <?= $form_data['gender'] === "Чоловік" ? "checked" : "" ?>><label for="male">Чоловік</label>
                    <input type="radio" name="gender" value="Жінка" <?= $form_data['gender'] === "Жінка" ? "checked" : "" ?>><label for="female">Жінка</label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="city" id="">
                        <option value="Житомир" <?= $form_data['city'] === "Житомир" ?  "selected" : "" ?>>Житомир</option>
                        <option value="Київ" <?= $form_data['city'] === "Київ" ? "selected" : "" ?>>Київ</option>
                        <option value="Вінниця" <?= $form_data['city'] === "Вінниця" ? "selected" : "" ?>>Вінниця</option>
                ...
                <td><input type="checkbox" name="games[]" value="World of Tanks" <?php
                                                                                    if (isset($form_data['games']))
                                                                                        if (in_array("World of Tanks", $form_data['games']))
                                                                                            echo "checked"; ?>>World of Tanks</td>
            </tr>
            <tr>
                <td><label for="info">Про себе:</label></td>
                <td><textarea name="info" id="" cols="20" rows="5"><?= isset($form_data['aboutMyself']) ? $form_data['aboutMyself'] : "" ?></textarea></td>
            </tr>
            <tr>
